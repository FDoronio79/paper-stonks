        ...
        <>
            ...
            <div className="container">
                <div className="col-lg-6 mx-auto ">
                    <p className="d-inline-flex p-2 row lead mb-4"></p>
                ...
                <div className="col-lg-6 mx-auto">
                    <p>
                        ...
                        development!
                        <br />
                        We are a paper trading app targeting finance enthusiasts
                        who want to practice their stock investment strategies.{" "}
                        <br />
                    </p>
                    <p>
                        ...
                        <div>
                            <p>
                                <h6>
                                    {" "}
                                    Visitors experience when not-logged in:{" "}
                                </h6>
                                Visitors of the site can view the site's
                                homepage <br />
                                The homepage features an about section with
                                company information and a guide on how to
                                navigate the site <br />
                                Using the search bar, visitors can search for
                                stocks of interest and go to it's page
                                <br />
